      ...
      <ha-card>
        ...
        <div class="scroll-content" style="max-height: ${c}px;">
          ${r.map((e=>F`
            ...
            ${e.matches.map((e=>{const t=`${e.home_team}_${e.away_team}`,i="in"===e.state,a=this._recentEventMatches.get(t),n=this._isWinner(e,"home"),s=this._isWinner(e,"away"),o=e.broadcast&&""!==e.broadcast&&"N/A"!==e.broadcast?e.broadcast:"",r="pre"===e.state;return F`
